PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    persist.sys.emm.cpugovernor=0 \
    persist.sys.emm.dramgovernor=0 \
    persist.sys.emm.gpugovernor=0 \
    persist.sys.mtk.pmspowerhint.disable=true \
    persist.sys.mtk.powerhaltouch.disable=true \
    persist.sys.mtk.sysfactory.disable=true \
    persist.sys.mtk.sysserver.disable=true \
    ...
    persist.vendor.mtk_usp_cfg_ctrl=1 \
    persist.vendor.mtk_usp_switch_mode=1 \
    persist.vendor.mtk_wfc_support=1 \
    persist.vendor.radio.fd.counter=150 \
    persist.vendor.radio.fd.off.counter=30 \
    persist.vendor.radio.fd.off.r8.counter=30 \
    ...
    ro.config.activitylaunching.rescheduleservice=true \
    ro.config.alarm_alert=Alarm_Classic.ogg \
    ro.config.batterystatstime=2400000 \
    ro.config.bgsettletime=30000 \
    ro.config.bgstarttimeout=5000 \
    ro.config.boundservicecrashmaxretry=5 \
    ro.config.earlyhomeapp=true \
    ro.config.fullpssloweredinterval=600000 \
    ro.config.fullpssmininterval=1800000 \
    ro.config.gcmininterval=120000 \
    ro.config.gctimeout=10000 \
    ro.config.keydispatchingtimeout=8000 \
    ro.config.low_ram=true \
    ro.config.maxcachedprocess=16 \
    ro.config.maxrecenttask=12 \
    ro.config.maxserviceinactivity=60000 \
    ro.config.monitorcpumintime=30000 \
    ro.config.notification_sound=OnTheHunt.ogg \
    ro.config.performancetype=true \
    ro.config.powercheckinterval=2 \
    ro.config.ringtone=Luna.ogg \
    ro.config.serviceminrestarttimebetween=30000 \
    ro.config.servicerestartduration=20000 \
    ro.config.serviceusageinteractiontime=2400000 \
    ro.config.slowoperationtimeout=200 \
    ro.config.speedupbgodex=true \
    ...
    ro.vendor.mediatek.version.release=alps-mp-p0.mp2-V3.5_foxconn.fih.ant.p0mp2.k39tv1.64.bsp_P21 \
    ...
    sys.emm.lmkminfree=15360,19200,23040,26880,34415,43737 \
    sys.emm.syslistpkg1=com.google.android.ims \
